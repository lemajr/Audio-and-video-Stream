...
<div className="absolute justify-center mt-12 grid justify-items-center md:mt-20 z-50">
  <div className="h-auto bg-blue-700 rounded-xl md:rounded-3xl w-80 max-md:w-[400px]">
